...
const Company = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const company = await fetch(
        editMode
          ? `${import.meta.env.VITE_API_BASE_URL}/pharmacy/companies/update/${editId}`
          : `${import.meta.env.VITE_API_BASE_URL}/pharmacy/companies/add`,
        {
  ...
  const handleDelete = async (id) => {
    try {
      const company = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/pharmacy/companies/del/${id}`,
        {
          method: "DELETE",
        }
      );
