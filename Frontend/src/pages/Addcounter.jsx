...
const AddCounter = () => {
    ...
    try {
      ...
      if (isEditing) {
        response = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/pharmacy/counter/update/${id}`,
          {
            method: "PUT",
            headers: {
        ...
        response = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/pharmacy/counter/add`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const handleDelete = async (counterId) => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/pharmacy/counter/del/${counterId}`,
        {
          method: "DELETE",
        }
      );
